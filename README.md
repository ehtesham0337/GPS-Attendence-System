...
#### A gps attendance system with the frontend on React.js and backend implemented with Django.

Attendees and Organizers can use it to join and view events in the form of tiles and mark their attendence when the timer is on. Googles's Geolocation API has been used to retrieve the coordinates. 
